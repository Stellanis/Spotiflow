...
def init_db():
    ...
    with get_connection() as conn:
        ...
        ''')
        c.execute('CREATE INDEX IF NOT EXISTS idx_stream_sources_track_lookup ON stream_sources(artist, title, updated_at DESC)')
        c.execute('CREATE INDEX IF NOT EXISTS idx_stream_sources_health ON stream_sources(health_status, updated_at DESC)')
        ...
        c.execute('CREATE INDEX IF NOT EXISTS idx_playback_events_session ON playback_events(session_id, created_at DESC)')
